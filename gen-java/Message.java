...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable, Comparable<Message> {
  ...
  private static final org.apache.thrift.protocol.TField MES_FIELD_DESC = new org.apache.thrift.protocol.TField("mes", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  public Message setMes(String mes) {
    this.mes = mes;
    return this;
  }
  ...
  public int hashCode() {
    ...
    boolean present_mes = true && (isSetMes());
    list.add(present_mes);
    if (present_mes)
      list.add(mes);
  ...
  public int compareTo(Message other) {
    ...
    lastComparison = Boolean.valueOf(isSetMes()).compareTo(other.isSetMes());
    if (lastComparison != 0) {
